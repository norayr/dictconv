...
#ifndef _PLAINTEXTDICTBUILDER_H_
#define _PLAINTEXTDICTBUILDER_H_
...
*/
class PlainTextDictBuilder : public DictBuilder
{
public:
  PlainTextDictBuilder( std::string filename );

  ~PlainTextDictBuilder();
...
#endif // _PLAINTEXTDICTBUILDER_H_
